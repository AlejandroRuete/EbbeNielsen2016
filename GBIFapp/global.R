...
CountEuropeCnt<-readShapePoints("data/countries Europe mean.shp", proj4string=CRS("+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs"))
CountEuropeCnt<-spTransform(CountEuropeCnt, CRS("+init=epsg:3857"))
