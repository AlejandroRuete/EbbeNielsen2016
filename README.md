...
This entry consists of:  
 ...
 - a [tutorial](https://github.com/AlejandroRuete/EbbeNielsen2016/tree/master/DataHandlingTutorial) on how to download and process the data in R to produce your own maps (mainly based on other excellent tutorials).
...
1.**Taxonomy**: applies to any species groups<sup>1</sup>, but has also applications at the species level.   
...
<sup>1</sup>: as reference taxonomic groups, defined below.
